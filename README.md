...
only two packages we include directly: `centos-release` and `micro-yuminst`.
The most interesting is obviously the latter - you can read about it
[here](https://gitlab.com/cgwalters/micro-yuminst).
